          ...
          >
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400">Velachery, Chennai</p>
                </div>
              </div>
              <div className="flex items-start space-x-4">
                <div className="flex-shrink-0 bg-indigo-900/30 p-3 rounded-full border border-indigo-500/30">
                ...
                <div>
                  ...
                  <p className="text-gray-400">manonmani1609@gmail.com</p>
                </div>
              </div>
              <div className="flex items-start space-x-4">
                <div className="flex-shrink-0 bg-indigo-900/30 p-3 rounded-full border border-indigo-500/30">
                ...
                <div>
                  ...
                  <p className="text-gray-400">+91 68833 29088</p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-8">
              ...
              <div className="flex space-x-4">
                ...
                <motion.a
                  href="https://www.behance.net/manonmani1609"
                  target="_blank"
                  rel="noopener noreferrer"
                  whileHover={{ y: -3 }}
                  className="bg-gray-700 p-3 rounded-full text-gray-300 hover:bg-indigo-900/30 hover:text-indigo-400 transition-colors"
