        ...
        <div className="flex flex-col md:flex-row items-center gap-12">
          ...
          >
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-6">
              ...
              user-friendly web applications using technologies like React, Node.js, React-Bootstrap, Tailwind CSS, MongoDB, Bootstrap, and JavaScript. I’m driven by a love for clean code, great design, and impactful digital experiences." </p>
...
const skills = [
  ...
  { name: 'Behance', icon: <FaBehance className="text-gray-700 dark:text-white" /> },
];
...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "1827249a-410e-480c-a798-81688107c1d9");
        ...
        <div className="flex flex-col md:flex-row gap-12">
          ...
          >
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-400">Velachery, Chennai</p>
                </div>
              </div>
              <div className="flex items-start space-x-4">
                <div className="flex-shrink-0 bg-indigo-100 dark:bg-indigo-900/30 p-3 rounded-full">
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-400">manonmani1609@gmail.com</p>
                </div>
              </div>
              <div className="flex items-start space-x-4">
                <div className="flex-shrink-0 bg-indigo-100 dark:bg-indigo-900/30 p-3 rounded-full">
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-400">+91 68833 29088</p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-8">
              ...
              <div className="flex space-x-4">
                <motion.a
                  href="https://github.com/manokaruppaiyan"
                  target="_blank"
                ...
                <motion.a
                  href="https://www.linkedin.com/in/manonmani1609/" 
                  target="_blank"
                  rel="noopener noreferrer"
                  whileHover={{ y: -3 }}
                  className="bg-gray-200 dark:bg-gray-700 p-3 rounded-full text-gray-700 dark:text-gray-300 hover:bg-indigo-100 dark:hover:bg-indigo-900/30 hover:text-indigo-700 dark:hover:text-indigo-400 transition-colors"
                ...
                <div className="md:w-1/2">
                  ...
                  >
                    <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 dark:text-white mb-4">
                      Hi, I'm <span className="text-indigo-600 dark:text-indigo-400">MANONMANI</span>
                    </h1>
